...
- Target URL: https://www.langchain.com/langsmith/engine
...
- After dropping files: enrich analysis.md / annotations.json / motion.md, then run `vibe-to-ui inspiration rebuild-preview langchain/engine`.
